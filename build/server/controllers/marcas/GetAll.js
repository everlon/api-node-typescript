...
const marcas_1 = require("../../database/providers/marcas");
...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield marcas_1.MarcasProvider.getAll(req.query.page || 1, req.query.limit || 10, req.query.filter || '', Number(req.query.id));
    const count = yield marcas_1.MarcasProvider.count(req.query.filter);
